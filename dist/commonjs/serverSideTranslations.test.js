        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              expect(_fs["default"].readdirSync).toHaveBeenCalledWith(expect.stringMatching('/public/locales/fr-CA'));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              expect(_fs["default"].readdirSync).toHaveBeenCalledWith(expect.stringMatching('/public/locales/nl-BE'));
